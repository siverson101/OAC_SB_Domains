...
Routes to the Unity 3D Orchestrator → UnityQA to run the **quality-gate** test stages.
...
1. Load context: `.opencode/context/unity-3d/lookup/validation-rules.md` + `guides/build-cli.md`
