---
id: uitk-interaction
summary: Hint alias for ui-interaction with stack=uitk.
family: run
mode: live
description: Hint alias. Resolves to the ui-interaction ability with the UI Toolkit stack hint; it has no separate runtime behaviour.
