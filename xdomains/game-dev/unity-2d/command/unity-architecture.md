---
description: Review or design Unity 2D project architecture, folder layout, and performance budgets
---

# Unity Architecture Command

Run directly by the Unity 2D Orchestrator to analyze/design project architecture.
...
1. Load context: `.opencode/context/unity-2d/concepts/project-layout.md` + `lookup/performance-budgets.md` + `navigation.md`
