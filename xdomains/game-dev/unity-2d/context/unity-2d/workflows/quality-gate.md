<!-- Context: unity-2d/workflows/quality-gate | Priority: high | Version: 1.0 | Updated: 2026-09-07 -->

# Workflow: Unity Quality Gate

**Purpose**: Full QA validation of Unity 2D changes — compile, tests, build smoke.
