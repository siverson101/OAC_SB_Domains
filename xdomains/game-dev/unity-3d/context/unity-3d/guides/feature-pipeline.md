<!-- Context: unity-3d/guides/feature-pipeline | Priority: high | Version: 1.0 | Updated: 2026-09-07 -->

# Feature Implementation Pipeline

The default path for adding a Unity 3D gameplay feature (moderate complexity).

## Stages

### 1. Understand & Scope
- Load `unity-3d/navigation.md`, `domain/unity-common.md`.
