<!-- Context: unity-2d/workflows/feature-delivery | Priority: high | Version: 1.0 | Updated: 2026-09-07 -->

# Workflow: Unity Feature Delivery

**Purpose**: Implement a Unity 2D gameplay feature end-to-end: implement → test → validate.
