...
Routes to the Unity 2D Orchestrator → UnityQA/UnityImplementer to run a **batch-mode build**.
...
1. Load context: `.opencode/context/unity-2d/guides/build-cli.md` + `lookup/validation-rules.md`
