---
description: Create or restructure a Unity 2D scene or prefab safely
---

# Unity Scene Command

Routes to the Unity 2D Orchestrator → UnityScene to run the **scene-assembly** workflow.
...
1. Load context: `.opencode/context/unity-2d/guides/scene-prefab-safety.md` + `concepts/project-layout.md`
