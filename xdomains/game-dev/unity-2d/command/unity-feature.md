---
description: Implement a Unity 2D gameplay feature end-to-end (implement → test → validate)
---

# Unity Feature Command

Routes to the Unity 2D Orchestrator to run the **feature-delivery** workflow.
...
1. Load context: `.opencode/context/unity-2d/navigation.md` + `domain/unity-common.md`
