---
description: Author Amplify Shader Editor node graphs for Unity 3D shaders
---

# Unity Amplify Shader Editor Command

Routes to the Unity 3D Orchestrator → UnityShaderVFX to author an **Amplify Shader Editor (ASE)** node graph.
